<div class="w-full">
 ...
 @endif
  ...
  <div  class="flex  p-5 w-3/4 my-4 mx-auto bg-white rounded-lg dark:bg-dark-eval-0" role="alert">
    ...
    <div class="ml-3 w-full flex-col md:flex-row text-xl flex justify-between font-medium text-gray-700 dark:text-gray-300">
  ...
  <div class="w-full mx-auto flex flex-col md:flex-row gap-2">
    <x-button wire:click="$set('modal', true)" class="w-[100px] sm:w-[100px]" variant="primary" >nuevo usuario</x-button>

<div class="w-full ">
    ...
    <div class="flex gap-4">
        ...
        <div class="flex flex-col min:h-96">
            Mes:
            <select name="" id="month_start" class="dark:bg-dark-eval-2 dark:text-white text-gray-700 bg=white" wire:model="month_start">
        ...
        <div class="flex flex-col">
            Año:
            <select name="" id="year_start" class="dark:bg-dark-eval-2 dark:text-white text-gray-700 bg=white" wire:model="year_start">
                <option value="0">---</option>
    ...
    @if(count($payments) > 0)
    <h2 class="w-full text-2xl my-3 font-light"> ganancias de {{$this->getMonthStart($month_start)}} {{$year_start}} hasta {{$this->getMonth($month)}} {{$year}} </h2>
    ...
    <div class="flex gap-2 justify-center  md:flex-row flex-col items-center sm:flex-row sm:justify-center my-4 h-auto flex-nowrap">
        ...
        <div class="flex flex-col sm:w-1/3 md:w-1/3 w-full  justify-between  bg-blue-600 dark:text-white text-gray-700 text-center h-48 p-2 rounded-md shadow-md">
            <p class="text-3xl text-gray-100">Q. {{$interests + $financialDefault}}</p>

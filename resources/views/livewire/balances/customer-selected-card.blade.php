<div class="flex p-4 my-4 w-3/4 mx-auto bg-white rounded-lg dark:bg-gray-700" role="alert">
    ...
    <button type="button"
        ...
        data-dismiss-target="#alert-5" aria-label="Close" wire:click="unSelectCustomer()">
